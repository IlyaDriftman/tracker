...
class TrackerCell: UICollectionViewCell {
  ...
  //  private let categoryLabel = UILabel()
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
           ...
           // titleLabel.topAnchor.constraint(equalTo: emojiView.bottomAnchor, constant: 8),
            ...
            //daysLabel.bottomAnchor.constraint(lessThanOrEqualTo: bottomAnchor, constant: -8),
    ...
    // MARK: - Configuration
    func configure(with tracker: Tracker, category: String, onPlusTapped: @escaping () -> Void, isCompletedToday: Bool, completedDays: Int, indexPath: IndexPath) {
